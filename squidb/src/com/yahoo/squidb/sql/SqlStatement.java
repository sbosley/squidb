...
public interface SqlStatement {
    ...
    /**
     * Compile this object into a SQL string and its arguments using the given flags
     *
     * @return a {@link CompiledStatement} generated from this object
     */
    CompiledStatement compile(VersionCode sqliteVersion, int flags);

    /**
     * @return the raw SQL string generated by this object
     */
    String toRawSql(VersionCode sqliteVersion, int flags);
}
